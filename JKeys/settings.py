"""
Django settings for JKeys project.
...
WSGI_APPLICATION = 'JKeys.wsgi.application'
...
# if the user want to test directly with the 'default' database values and not tests_jkeys
import sys
...
# Email redirection to reset password
